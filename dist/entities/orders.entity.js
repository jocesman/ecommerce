...
let Orders = class Orders {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, createdAt: { required: true, type: () => Date }, orderDetails: { required: true, type: () => require("./orderDetails.entity").OrderDetails }, user: { required: true, type: () => require("./users.entity").Users } };
    }
};
...
__decorate([
    (0, typeorm_1.OneToOne)(() => orderDetails_entity_1.OrderDetails, {
        cascade: true,
        onDelete: 'CASCADE',
    }),
